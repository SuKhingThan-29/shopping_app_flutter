...
ProductTabResponse productTabResponseFromJson(String str) =>
    ProductTabResponse.fromJson(json.decode(str));

String productTabResponseToJson(ProductTabResponse data) =>
    json.encode(data.toJson());

class ProductTabResponse {
  ProductTabResponse({
    this.products,
   // this.meta,
    this.success,
 ...
 // Meta? meta;
  ...
  factory ProductTabResponse.fromJson(Map<String, dynamic> json) =>
      ProductTabResponse(
        products:
